...
- チャットで話したノウハウは揮発する。ライブラリに反映しないと次回また同じ議論から始まる
- 課題と対処を整理してから形式化する。具体例なしに抽象化すると使えないスキルになる
- スキルは「実際に役立ったこと」だけを形式化する。思いつきや仮説は価値がない
...
- 前提: なし（どの作業の後でも使える）
- このスキル自体がライブラリのメンテナンス手段であり、「次のステップ」は形式化した先の Skill
...
- [ ] 「このノウハウが次回また別の文脈で役立つか」を一言で説明できる
- [ ] 既存スキルと重複していないか確認した
- [ ] 機密情報・個人情報が含まれていないか確認した
